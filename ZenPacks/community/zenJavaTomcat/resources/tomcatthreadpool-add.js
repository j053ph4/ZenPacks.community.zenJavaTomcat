...
(function() {
            ...
            Ext.ComponentMgr.onAvailable('component-add-menu', function(config) {
                ...
                menuButton.menuItems.push({
                    xtype: 'menuitem',
                    text: _t('Add Tomcat Thread Pool') + '...',
                    hidden: Zenoss.Security.doesNotHavePermission('Manage Device'),
                    handler: function() {
                        var win = new Zenoss.dialog.CloseDialog({
                            width: 300,
                            title: _t('Add Tomcat Thread Pool'),
                            items: [{
                                xtype: 'form',
                                buttonAlign: 'left',
                                monitorValid: true,
                                ...
                                items:                         [
                            {
                                ...
                                buttons: [{
                                    ...
                                    handler: function(b) {
                                        ...
                                        Zenoss.remote.zenJavaTomcatRouter.addTomcatThreadPoolRouter(opts,
                                        function(response) {
                                            if (response.success) {
                                                new Zenoss.dialog.SimpleMessageDialog({
                                                    title: _t('Tomcat Thread Pool Added'),
